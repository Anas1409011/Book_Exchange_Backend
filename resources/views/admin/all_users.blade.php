...
@section('content')
  ...
  <!-- end: Favicon -->
      ...
      <h2 style="font-size:25px; text-align: center; padding: 10px">List of All Users</h2>
        ...
        @foreach($all_products as $products)
              ...
              <tr>
                ...
                <td style="text-align: center;">{{$products->email}}</td>
                <td style="text-align: center;">

                  <!--/ Edit Button -->
                  <a class="btn btn-info" href="{{URL::to('/edit_product/'.$products->id)}}">Edit
                    <i class="halflings-icon white edit"></i>                                            
                  </a>
                  <!--/ Delete Button -->
                  <a class="btn btn-danger" href="{{URL::to('/delete_product/'.$products->id)}}">Delete
